...
const MultichainSmartContracts = (props: SVGProps<SVGSVGElement>) => (
	...
	>
		...
		<rect
			...
			strokeWidth={2.5}
		/>
		<path d="M14 2.42554V24.7113" stroke="black" strokeWidth={2.5} />
		<path
			d="M25.1429 13.5684L2.85717 13.5684"
			stroke="black"
			strokeWidth={2.5}
		/>
		<circle cx={20} cy={7.56838} r={2.57143} stroke="black" strokeWidth={2.5} />
		<path
