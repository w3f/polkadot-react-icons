...
const WalletDeposit = (props: SVGProps<SVGSVGElement>) => (
	<svg
		...
		{...props}
	>
		<path d="M20.9449 2H2V17.9603H20.9449V2Z" stroke="black" />
		<path
		...
		<path
			...
			fill="none"
		/>
		<path d="M11.0732 25L11.0732 18.3316" stroke="black" />
		<path d="M14.0181 10.0181L14 10" stroke="black" strokeMiterlimit={10} />
	</svg>
)
