...
const ExistentialDeposit = (props: SVGProps<SVGSVGElement>) => (
	<svg
		...
		{...props}
	>
		<path d="M2 17.5V23H26V17.5" stroke="black" fill="none" />
		<circle cx={14} cy={9.5} r={8} stroke="black" />
		<path
			...
			stroke="black"
		/>
		<path d="M14.0488 5.97504V4.74445" stroke="black" />
		<path d="M14.0488 14.2556V13.1204" stroke="black" />
	</svg>
)
