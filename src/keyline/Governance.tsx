...
const Governance = (props: SVGProps<SVGSVGElement>) => (
	<svg
		...
		{...props}
	>
		<circle cx={14.0001} cy={13.8747} r={3.30708} stroke="black" />
		<circle cx={14.0001} cy={24.1101} r={1.88976} stroke="black" />
		<circle cx={14.0001} cy={3.88976} r={1.88976} stroke="black" />
		<circle
			cx={24.1102}
			cy={13.9999}
			r={1.88976}
