...
const ProofOfStake = (props: SVGProps<SVGSVGElement>) => (
	<svg
		width="28"
		height="28"
		viewBox="0 0 27 28"
	...
	>
		...
		/>
		<path
			d="M18.1556 8.5H8.6507V12.8204H18.1556V8.5Z"
			stroke="black"
			strokeWidth={2.5}
		/>
		<path
			d="M10.8109 8.03779L10.8109 7.27783V7.27783C10.8109 6.26587 11.6312 5.44553 12.6432 5.44553H14.1631C15.175 5.44553 15.9954 6.26587 15.9954 7.27783V7.27783L15.9954 8.03779"
			stroke="black"
			strokeWidth={2.5}
		/>
	</svg>
