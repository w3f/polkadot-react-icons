...
const Security = (props: SVGProps<SVGSVGElement>) => (
	...
	>
		<path
			d="M1.35229 5.23344V14.2632C1.35229 17.6625 3.07919 20.8291 5.93697 22.67L11.9277 26.529L18.065 22.5737C20.9217 20.7326 22.6478 17.5667 22.6478 14.1681V5.23344L11.9952 1.33521L1.35229 5.23344Z"
			stroke="black"
			strokeWidth={2.5}
		/>
		<path
