...
const RelayChain = (props: SVGProps<SVGSVGElement>) => (
	...
	>
		<g>
			...
			<path d="M19.6507 8.36254V8.33691" strokeMiterlimit={10} />
			<path d="M8.34877 19.6641V19.6385" strokeMiterlimit={10} />
			<path d="M19.6379 19.6513H19.6636" strokeMiterlimit={10} />
			<path d="M8.33597 8.34973H8.3616" strokeMiterlimit={10} />
		</g>
	</svg>
)
