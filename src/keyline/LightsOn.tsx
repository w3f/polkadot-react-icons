...
const LightsOn = (props: SVGProps<SVGSVGElement>) => (
	...
	>
		...
		/>
		<path
			d="M13.9883 5.12823L13.9883 2.12823"
			stroke="black"
			strokeWidth={2.5}
		/>
		<path
			d="M1.98834 14.1282L4.98834 14.1282"
			stroke="black"
			strokeWidth={2.5}
		/>
		<path
			d="M22.9883 14.1282L25.9883 14.1282"
			stroke="black"
			strokeWidth={2.5}
		/>
		<path
			d="M20.3523 7.76437L22.4736 5.64305"
			stroke="black"
			strokeWidth={2.5}
		/>
		<path
			d="M5.50283 5.64293L7.62415 7.76425"
			stroke="black"
			strokeWidth={2.5}
		/>
	</svg>
