...
const Specialised = (props: SVGProps<SVGSVGElement>) => (
	...
	>
		<path
			d="M13.8717 26.7691C20.9049 26.7691 26.6064 21.0676 26.6064 14.0344C26.6064 7.0013 20.9049 1.2998 13.8717 1.2998C6.83858 1.2998 1.13708 7.0013 1.13708 14.0344C1.13708 21.0676 6.83858 26.7691 13.8717 26.7691Z"
			stroke="black"
		/>
		<path
